def main( room ): # room - номер комнаты, которую ищем
    ...
    while True:
        ...
        for i in range(0, side):
            ...
            # TODO: ускорить алгоритм
            # есть еще идея в этом месте не прыгать по одному этажу, а сразу перейти на нужный этаж
            # для этого нужно использовать целочисленное деление номера команты (начиная от начала текущего квадарта)
            # на размер квадрата
